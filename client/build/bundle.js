...
/***/ function(module, exports, __webpack_require__) {
	...
	var BorderCountry = __webpack_require__(162);
	...
	var CountriesBox = React.createClass({
	  ...
	  borderInfo: function borderInfo(country) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.displayCountry) {
	      displayElement = React.createElement(CountryDisplay, { countryDetails: this.state.displayCountry });
	    }
	
	    var displayBorders = React.createElement(
	      'h4',
	      null,
	      'no bordering countries'
	    );
	    if (this.state.borders) {
	      displayBorders = React.createElement(BorderCountry, { borderInfo: this.state.borders });
	    }
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        ' Country population: ',
	        this.props.countryDetails.population
	      ),
	      React.createElement(
	        'h4',
	        null,
	        ' Country Capital City: ',
	        this.props.countryDetails.capital
	      ),
	      React.createElement(
	        'h4',
	        null,
	        ' Country Native Spelling: ',
	        this.props.countryDetails.nativeName
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BorderCountry = React.createClass({
	  displayName: 'BorderCountry',
	
	
	  displayBorders: function displayBorders() {
	    var _iteratorNormalCompletion = true;
	    var _didIteratorError = false;
	    var _iteratorError = undefined;
	
	    try {
	      for (var _iterator = this.props.borderInfo[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        country = _step.value;
